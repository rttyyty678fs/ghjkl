...
UUID=${UUID:-'2a3bbf2a-d7e4-4bfb-b7d9-4ce5d7168513'}
VMESS_WSPATH=${VMESS_WSPATH:-'/2a3bbf2a-d7e4-4bfb-b7d9-4ce5d7168513'}
VLESS_WSPATH=${VLESS_WSPATH:-'/2a3bbf2a-d7e4-4bfb-b7d9-4ce5d7168513'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/2a3bbf2a-d7e4-4bfb-b7d9-4ce5d7168513'}
SS_WSPATH=${SS_WSPATH:-'/2a3bbf2a-d7e4-4bfb-b7d9-4ce5d7168513-shadowsocks'}
